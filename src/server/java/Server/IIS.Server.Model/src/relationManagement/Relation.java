 ...
 */
	...
	private PersistenceDMLExecuter dmlExecuter;  // NEWC-changed
	//public Relation(String relationname) { // NEWC - deleted
	public Relation(String relationname, String servicename) { // NEWC - changed
		this.elements = new ArrayList<>();
		this.SIndex = new HashMap<S,List<T>>();
		this.TIndex = new HashMap<T,List<S>>();
		this.relationname = relationname;
		this.dmlExecuter = PersistenceExecuterFactory.getConfiguredFactory().getDBDMLExecuter(servicename); // NEWC-Inserted
	}
